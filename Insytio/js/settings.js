...
$(function(){
    ...
    /**
     * insytioSettingsBundle provides a convenient way to access insytio related localStorage options.
     * Settings should be explicitly saved by calling save() method after changing some property
     * @constructor
     * @example
     * insytioSettings.set('nav-static', false);
     * insytioSettings.save();
     */
    var insytioSettingsBundle = function(){
        var defaultSettings =  {
            /**
        ...
        this.settingName = 'insytio-app-settings';
        this._settings = JSON.parse(localStorage.getItem(this.settingName)) || defaultSettings;
    };

    insytioSettingsBundle.prototype.save = function(){
        localStorage.setItem(this.settingName, JSON.stringify(this._settings));
        return this;
    };

    insytioSettingsBundle.prototype.get = function(key){
        return this._settings[key];
    };

    insytioSettingsBundle.prototype.set = function(key, value){
        this._settings[key] = value;
        return this;
    };

    window.insytioSettings = new insytioSettingsBundle();
});