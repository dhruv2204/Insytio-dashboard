...
! function(e, t) {
    ...
    var s = {},
        ...
        pt = "tinymce/Compat",
        ht = "tinymce/ui/Layout",
        mt = "tinymce/ui/AbsoluteLayout",
    ...
    r(l, [], function() {
                ...
                if (i = e[c]) {
                    if (f = s[i], n) {
                        for (n = n.split(" "), l = n.length; l--;)
                            if (u = n[l], o = f[u]) {
                                if (r)
                                    for (d = o.length; d--;) o[d].func === r && o.splice(d, 1);
        ...
        return function(e) {
            ...
            function u(e) {
                var n, r, o, a, s, c, u, f, p, h, m, g, y, C, x, w, _, N, E, k = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/,
                    S = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/,
                    T = /[*?+]/;
                if (e)
        ...
        return function(n, i) {
            ...
            n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                var a = this,
                    s, l = 0,
                    c, d, u = [],
                    f, p, h, m, g, v, y, b, C, x, w, _, N, E, k, S, T, R, A, B, H, M, L, D, P, O = 0,
                    I = t.decode,
                    F;
        ...
        return function(r, i) {
            ...
            var b = i.dom,
                C = t.each,
                x, w, _, N, E, k, S, T, R, A, B, H, M, L, D = i.getDoc(),
                P = document,
                O = n.ie,
                I;
            _ = {
        ...
        return function(r) {
            ...
            function p(t, n, o) {
                ...
                if (m)
                    if (o) o.nodeType ? (y = I.createRng(), y.setStartBefore(o), y.setEndAfter(o), u(T(y, h), null, !0)) : u(o, null, !0);
            ...
            o(this, {
                ...
                mceInsertContent: function(t, r, i) {
                    ...
                    if (/^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), b = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {
                        ...
                        }, u = a.parse(i, f), v = u.lastChild, "mce_marker" == v.attr("id"))
        ...
        return function(t) {
            function n() {
                if (!h)
                    if (h = [], u.find) u.find("*").each(function(e) {
                        e.canFocus && h.push(e.getEl())
                    });
                    else
                        for (var e = u.getEl().getElementsByTagName("*"), t = 0; t < e.length; t++) e[t].id && e[t] && h.push(e[t])
            }
        ...
        return e.extend({
            recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, d, u, f, p, h, m, g, v = [],
                    y, b, C, x, w, _, N, E, k, S, T, R, A, B, H, M, L, D, P, O, I, F, W, z, V = Math.max,
                    U = Math.min;
        ...
        return e.extend({
            recalc: function(e) {
                var t = e.settings,
                    n, r, i, o, a, s, l, c, d, u, f, p, h, m, g, v, y, b, C, x, w, _, N = [],
                    E = [],
                    k, S, T, R, A, B;
